...
struct SkeletonPass : public FunctionPass {
    ...
    // Algorithms explained in Ch-7:Control Flow Analysis : Advanced Compiler Design and Implementation.pdf by Steven Muchnick
    struct Flowgraph
    {
    ...
    */
    ...
    void find_nestedLoops(map<int, set<string>>& loopMap)
    {
        errs() << "\n\nNested Relationship \n";
        errs() << "------------------------\n";
